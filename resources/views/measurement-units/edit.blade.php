    ...
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
        ...
        <div class="sm:flex sm:justify-between sm:items-center mb-8">
            <div class="mb-4 sm:mb-0">
                <h1 class="text-2xl md:text-3xl text-gray-800 dark:text-gray-100 font-bold">{{ __('Editar Unidad de Medida') }}</h1>
            </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input id="code" name="code" type="text"
                                       value="{{ old('code', $measurementUnit->code) }}"
                        ...
                        <div class="flex items-center">
                            <label for="status" class="inline-flex items-center cursor-pointer">
                                <input id="status" name="status" type="checkbox"
                                       ...
                                       {{ old('status', $measurementUnit->status) ? 'checked' : '' }} />
