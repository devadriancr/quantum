    ...
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
        ...
        <div class="sm:flex sm:justify-between sm:items-center mb-8">
            <div class="mb-4 sm:mb-0">
                <h1 class="text-2xl md:text-3xl text-gray-800 dark:text-gray-100 font-bold">Editar Usuario</h1>
        ...
        <form method="POST" action="{{ route('users.update', $user) }}">
            ...
            <div class="bg-white dark:bg-gray-800 shadow-xs rounded-xl border border-gray-200 dark:border-gray-700/60 p-6 mb-6">
                <div class="flex items-start justify-between mb-5">
                    <div>
                        ...
                        <p class="text-xs text-gray-400 dark:text-gray-500 mt-0.5">Déjala en blanco para no cambiarla.</p>
                    </div>
                </div>
            ...
            {{-- Info extra --}}
            <div class="bg-gray-50 dark:bg-gray-900/20 rounded-xl border border-gray-200 dark:border-gray-700/60 px-5 py-4 mb-6 flex items-center gap-4 text-xs text-gray-500 dark:text-gray-400">
                ...
                <span>
                    ...
                    @if($user->email_verified_at)
                        · Email verificado el
                        <span class="font-medium text-gray-700 dark:text-gray-300">{{ $user->email_verified_at->format('d/m/Y') }}</span>
                    @else
                        · <span class="text-amber-500">Email sin verificar</span>
                    @endif
                </span>
            </div>
