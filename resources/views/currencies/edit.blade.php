    ...
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
        ...
        <form method="POST" action="{{ route('currencies.update', $currency) }}">
            ...
            <div class="bg-white dark:bg-gray-800 shadow-xs rounded-xl border border-gray-200 dark:border-gray-700/60 p-6 mb-6">
                <h2 class="text-sm font-semibold text-gray-700 dark:text-gray-300 uppercase tracking-wide mb-5">Información de la Moneda</h2>

                <!-- Sistema de rejilla de 12 columnas para simetría perfecta -->
                <div class="grid grid-cols-12 gap-x-6 gap-y-5">
                    ...
                    <div class="col-span-12 md:col-span-6">
                        ...
                        <input type="text" value="{{ $currency->code }}" disabled
                               class="form-input w-full font-mono bg-gray-50 dark:bg-gray-700 border-gray-200 dark:border-gray-600 rounded-lg text-gray-500 dark:text-gray-400 cursor-not-allowed">
                        <p class="text-xs text-gray-400 dark:text-gray-500 mt-1">El código no se puede modificar.</p>
                    </div>
                    ...
                    <div class="col-span-12 md:col-span-4">
                        ...
                        <input type="text" name="symbol" value="{{ old('symbol', $currency->symbol) }}" maxlength="10"
                    ...
                    <div class="col-span-12 md:col-span-4">
                        ...
                        <input type="number" name="units_per_usd" step="0.000001" min="0.000001"
                               value="{{ old('units_per_usd', $currency->units_per_usd) }}"
                    ...
                    <div class="col-span-12 md:col-span-4 md:pt-6">
                        <div class="flex items-center h-[42px]">
                            <label class="flex items-center gap-2 cursor-pointer bg-gray-50 dark:bg-gray-700/30 border border-gray-200 dark:border-gray-700/60 rounded-lg px-4 py-2.5 w-full hover:bg-gray-100 dark:hover:bg-gray-700/50 transition">
                                <input type="checkbox" name="active" value="1" {{ old('active', $currency->active) ? 'checked' : '' }}
