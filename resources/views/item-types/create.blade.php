<x-app-layout>
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
        ...
        <div class="md:grid md:grid-cols-3 md:gap-6">
            <x-section-title>
                <x-slot name="title">Create Item Type</x-slot>
                <x-slot name="description">Add a new item type to the system.</x-slot>
            </x-section-title>
                    ...
                    <form action="{{ route('item-types.store') }}" method="POST">
                        ...
                        <div class="grid grid-cols-6 gap-6">
                            <div class="col-span-6 sm:col-span-3">
                                ...
                                <x-input id="code" type="text" name="code" value="{{ old('code') }}"
                                    required autofocus />
