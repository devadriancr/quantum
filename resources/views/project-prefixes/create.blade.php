    ...
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
        ...
        <div class="sm:flex sm:justify-between sm:items-center mb-8">
            <div class="mb-4 sm:mb-0">
                <h1 class="text-2xl md:text-3xl text-gray-800 dark:text-gray-100 font-bold">{{ __('Nuevo Prefijo') }}</h1>
            </div>
        ...
        <div class="bg-white dark:bg-gray-800 shadow-xs rounded-xl">
            ...
            <header class="px-5 py-4 border-b border-gray-100 dark:border-gray-700/60">
                <h2 class="font-semibold text-gray-800 dark:text-gray-100">{{ __('Información del prefijo') }}</h2>
            </header>

            <div class="px-5 pt-5 pb-2">
                <ul class="divide-y divide-gray-100 dark:divide-gray-700/60 text-sm mb-4">

                    <form id="prefix-form" action="{{ route('project-prefixes.store') }}" method="POST">
                        @csrf
                            ...
                            <div class="flex items-start gap-3">
                                ...
                                <div class="flex-1">
                                    <input id="description" name="description" type="text"
                                           ...
                                           placeholder="{{ __('Descripción del prefijo') }}"
