    ...
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
        ...
        <div class="sm:flex sm:justify-between sm:items-center mb-8">
            <div class="mb-4 sm:mb-0">
                <h1 class="text-2xl md:text-3xl text-gray-800 dark:text-gray-100 font-bold">{{ __('Detalle del Tipo de Artículo') }}</h1>
            </div>
        ...
        <div class="bg-white dark:bg-gray-800 shadow-xs rounded-xl">
            <header class="px-5 py-4 border-b border-gray-100 dark:border-gray-700/60">
                <h2 class="font-semibold text-gray-800 dark:text-gray-100">{{ $itemType->name }}</h2>
            </header>
            <div class="p-5">
                <ul class="divide-y divide-gray-100 dark:divide-gray-700/60 text-sm">

                    {{-- Renglón con dos columnas (Código y Nombre) --}}
                    <li class="grid grid-cols-1 md:grid-cols-2 py-3 gap-4">
                        ...
                        <div class="flex items-center">
                            ...
                            <span class="font-medium text-gray-800 dark:text-gray-100">{{ $itemType->name }}</span>
                        </div>
                    </li>
                    ...
                    {{-- Fechas (también en dos columnas para ahorrar espacio) --}}
