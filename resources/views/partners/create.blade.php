    ...
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
        ...
        <div class="sm:flex sm:justify-between sm:items-center mb-8">
            <div class="mb-4 sm:mb-0">
                <h1 class="text-2xl md:text-3xl text-gray-800 dark:text-gray-100 font-bold">{{ __('Nuevo Socio') }}</h1>
            </div>
        ...
        <div class="bg-white dark:bg-gray-800 shadow-xs rounded-xl">
            ...
            <header class="px-5 py-4 border-b border-gray-100 dark:border-gray-700/60">
                <h2 class="font-semibold text-gray-800 dark:text-gray-100">{{ __('Información del socio') }}</h2>
            </header>
                            ...
                            <div class="flex items-start gap-3">
                                ...
                                <div class="flex-1">
                                    <input id="name" name="name" type="text"
                                           value="{{ old('name') }}"
                                           placeholder="{{ __('Nombre del socio') }}"
                            ...
                            <div class="flex items-start gap-3">
                                ...
                                <div class="flex-1">
                                    <select id="partner_type" name="partner_type"
                                        ...
                                        <option value="supplier" @selected(old('partner_type') === 'supplier')>{{ __('Proveedor') }}</option>
                                        <option value="customer" @selected(old('partner_type') === 'customer')>{{ __('Cliente') }}</option>
                                        <option value="both"     @selected(old('partner_type') === 'both')>{{ __('Ambos') }}</option>
                                    </select>
                                    @error('partner_type')
                                        <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                                    @enderror
                            ...
                            <div class="flex items-start gap-3">
                                ...
                                <div class="flex-1">
                                    <select id="status" name="status"
                                        ...
                                        <option value="ACTIVE"   @selected(old('status', 'ACTIVE') === 'ACTIVE')>{{ __('Activo') }}</option>
                                        <option value="INACTIVE" @selected(old('status') === 'INACTIVE')>{{ __('Inactivo') }}</option>
                                    </select>
                                    @error('status')
                                        <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                                    @enderror
                            ...
                            <div class="flex items-start gap-3">
                                ...
                                <div class="flex-1">
                                    <input id="contact_phone" name="contact_phone" type="text"
                                           ...
                                           placeholder="{{ __('Ej. +52 55 0000 0000') }}"
                            ...
                            <div class="flex items-start gap-3 md:col-span-2">
                                ...
                                <div class="flex-1">
                                    <input id="address" name="address" type="text"
                                           value="{{ old('address') }}"
                                           placeholder="{{ __('Calle, número, colonia...') }}"
                            ...
                            <div class="flex items-start gap-3">
                                ...
                                <div class="flex-1">
                                    <input id="city" name="city" type="text"
                                           value="{{ old('city') }}"
                                           placeholder="{{ __('Ej. Ciudad de México') }}"
