    ...
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
        ...
        <div class="sm:flex sm:justify-between sm:items-center mb-8">
            <div class="mb-4 sm:mb-0">
                <h1 class="text-2xl md:text-3xl text-gray-800 dark:text-gray-100 font-bold">{{ __('Nueva Especificación de Empaque') }}</h1>
            </div>
        ...
        <div class="bg-white dark:bg-gray-800 shadow-xs rounded-xl">
            ...
            <header class="px-5 py-4 border-b border-gray-100 dark:border-gray-700/60">
                <h2 class="font-semibold text-gray-800 dark:text-gray-100">{{ __('Información de la Especificación') }}</h2>
            </header>

            <form id="spec-form" action="{{ route('packing-specifications.store') }}" method="POST">
                @csrf
